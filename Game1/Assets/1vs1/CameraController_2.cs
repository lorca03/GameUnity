...
public class CameraController_2 : MonoBehaviour
{
    ...
    void Start()
    {
        Player = FindObjectOfType<MovimientoPlayer_2>().gameObject;
        playercControl = FindObjectOfType<PlayerController_2>().gameObject;
    ...
    void Update()
    {
        ...
        if (playercControl.GetComponent<PlayerController_2>().b_Muerto)
        {
            audioSource.Stop();
        }
